...
if ($rotina->validaSessao('', '2') == 1) {
                ...
                <div class="col-xs-10 col-xs-offset-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="mes" name="mes" onchange="pegaMesSint()">
                            ...
                            <?php
                                $resultado_detalhada1 = $circuitos->listaPeriodoRef($forncad);
                        ...
                        <div class="col-xs-6 col-xs-3">
                            <br /><a id="linkprint" type="button" class="btn btn-info" target="_blank" href="./relatorios/contas_sintetico.php?periodo=<?php echo $mescad . "&fatura=" . $fatura . "&fornecedor=" . $forncad; ?>">Imprimir Relatório <span class="glyphicon glyphicon-print"></span></a>
                        </div>
                    </div>
    ...
    <div class="col-xs-10">
        <table class="table table-hover table-striped table-condensed">
            ...
            <tbody>
                <?php
                    $resultado_detalhada2 = $circuitos->listaConsultaDetalhada($unidade, $fatura, $circuito, $diretoria, $mescad, $inep, $forncad);
