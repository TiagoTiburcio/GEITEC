                            ...
                            if (($first) && (($filtro_situacao == '2') || ($filtro_situacao == $circTable['value']))) {
                                ...
                                <table class="table table-striped table-responsive">        
                                    ...
                                    <tbody>    
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo '<a href="circuito.php?ckt='.$circTable['designacao'].'" target="_about" data-toggle="tooltip" data-placement="right" title="Pagina Circuito" >'. $circTable['designacao'].'</a>'; ?></td>                   
