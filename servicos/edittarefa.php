...
?>  <div class="col-xs-offset-1 col-xs-2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <a type="button" class="btn btn-primary" <?php if ( $tarefa1->getNumTarefa() != "" ) { echo "href='http://redmine.seed.se.gov.br/redmine/issues/". $tarefa1->getNumTarefa()."'";}?>  target="_blank" ><span class="glyphicon glyphicon-list"></span></a>
                        </div>
                    </div>  
                </div>
                <div class="form-group">
        ...
        <?php } elseif ($testeAntes == 1) { echo " Não Possui Tarefa Anterior!!! "; } ?>
    </div>                  
    ...
    <div class="col-xs-offset-1 col-xs-2">
              ...
              <div class="col-xs-12">                                     
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        ?>">
                        <div class="input-group-btn">
                            <a type="button" class="btn btn-primary" <?php if ( $tarefa2->getNumTarefa() != "" ) { echo "href='http://redmine.seed.se.gov.br/redmine/issues/". $tarefa2->getNumTarefa()."'";}?>  target="_blank" ><span class="glyphicon glyphicon-list"></span></a>
                        </div>
                    </div>  
                </div>
                <div class="form-group">
        ...
        <?php } elseif ($testeDepois == 1 ) { echo ' Não Possui Tarefa Após a Atual!!! '; } ?>
    </div>             
    </div>
<?php
